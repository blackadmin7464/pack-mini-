...
var int = setInterval(() => 
{
    ...
    if (proxy && proxy.length > 5) {
        ...
        for (var i = 0; i < 200; i++) { // i < 200; bölümünü elleyebilirsin 200'ü 300 veya 50 vb yapabilirsin threads dedigimiz bu oluyor.
...
setTimeout(() => clearInterval(int), time * 1000); //zamani 1000 ile böl